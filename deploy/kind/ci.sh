...
docker pull docker.pkg.github.com/oktalz/go-web-simple/srv:1.1.5
docker image tag docker.pkg.github.com/oktalz/go-web-simple/srv:1.1.5 go-web-simple:1.1
